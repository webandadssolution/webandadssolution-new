...
const reviews = [
    ...
    {
        rating: 5.0,
        text: "Great team, great customer services, will reference more friend who need to build website. Fast and beautiful work done. Thank you Web and Ads solution. You did great job for my website.",
        name: "Quyen DoYoder",
        role: "United States",
        image: "/client/quyen-doyoder.jpg"
    },
    {
        rating: 5.0,
        text: "From my first encounter with Webandadsolution I felt confident I had chosen the right company. Their creativity and dedication to expanding our nonprofit ASA (America Supporting Americans) has been heartwarming. My manager Simi and her crew are professional, always ready to answer questions and follow through on every request. Rest assured — this is a 5 Star ++ Company.",
        name: "Linda Patterson",
        role: "United States",
        image: "/client/linda.jpeg"
    }
];
